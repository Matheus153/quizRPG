    ...
    animate="show">
      ...
      <Widget.Content> 
        ...
        <h5 style= {{
          ...
          { score >= 5 && score < 8 && `Caramba! Você é um aventureiro nato. Possue excelentes atributos e um carisma de fazer inveja a qualquer um. Você provavelmente sobreviveria a está aventura!`}
